...
class R2Environment:
    ...
    def get_action(self, state):
        ...
        elif self.strategy in ['ppo', 'online_rl']:
...
def objective(trial):
    ...
    avg_r2_score = -np.mean(total_r2_score)
    
    # Check if there is any completed trial or not
    if not study.best_trials or avg_r2_score < study.best_value:
